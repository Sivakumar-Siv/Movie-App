...
const WatchList = () => {
   ...
   const filterMovies = watchlist.filter((movie) => 
  ...
  return (
    ...
    <input type="text" placeholder='Search Movies....' className='p-2 w-3/4 md:w-1/2 border rounded border-gray-700 bg-gray-900 bg-opacity-60
